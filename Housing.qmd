...
Students were asked to report information regarding their current and past housing situations. This includes housing changes due to COVID, if they were living near their college, the type of home they  were currently living in, and any hardships they faced in the past year with housing.
...
#| fig-width: 4.5
#| label: fig-q24
#| fig-cap: !expr sprintf("Students Living Near Their College %s", print_n_reporting('q24'))
...
```{r}
#| tbl-cap: !expr sprintf("Current Housing Situation %s", print_n_reporting('q25'))
#| label: tbl-q25
...
```{r}
#| tbl-cap: !expr sprintf("Housing Security Screening")
#| label: tbl-past12months
...
**Additional Notes: ** The n count next to each label represents the total number of non-missing responses. These eight questions are used to screen for housing insecurity.
...
```{r}
#| tbl-cap: !expr sprintf("Sleeping Locations")
#| label: tbl-q36
...
```{r}
#| tbl-cap: !expr sprintf("Housing Insecurity & Homeless")
#| label: tbl-housing_insecure
...
```{r}
#| tbl-cap: !expr sprintf("Housing Barriers %s", print_n_reporting('housing_barrier_deposit_funds'))
#| label: tbl-barrier
...
#| fig-height: 4.3
#| fig-width: 4.5
#| fig-cap: !expr sprintf("Number of Times Moved in the Past 12 months %s", print_n_reporting('q24'))
#| label: fig-unstable
...
#| fig-height: 5
#| fig-width: 9
#| fig-cap: !expr sprintf("Most Common Reason for Experiencing Unstable Housing %s", print_n_reporting('q37'))
#| label: fig-unstable_housing_reason
...
#| fig-height: 3
#| fig-width: 4
#| fig-cap: !expr sprintf("COVID Housing Impact %s", print_n_reporting('q23'))
#| label: fig-q23
...
```{r}
#| tbl-cap: !expr sprintf("Reported Reasons for a Change in Housing Stability From COVID %s", print_n_reporting('covid_housing_off_campus_job'))
#| label: tbl-covid_housing

...
- This report provides a top level descriptive analysis of each question in the survey.
...
- The impact of receiving [CalFresh](https://www.csuchico.edu/calfresh/index.shtml) benefits
- Barriers to applying to CalFresh
- College student food insecurity
- The impact of and barriers to using food pantries
...
- Students who met the eligibility criteria of being undergraduate EOP/EOPS students and receiving less than 11 meals per week from other services (used as an eligibility criteria when determining CalFresh eligibility) were then emailed a survey. 
- Participants were given a \$25 gift card incentive for completing the survey. 
- EOP/EOPS students were identified as the target population for this survey based on their low-income and first-generation student status, which indicates a higher probability of using CalFresh and being likely eligible for CalFresh.

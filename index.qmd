...
Names <- c("Allan Hancock CC (n = 108)", "Butte CC (n = 124)" ,
           "Mt. SAC CC (n = 247)", "Clovis CC (n = 136)", 
           "Palo Verde CC (n = 35)",
           "Cal State San Bernardino (n = 183)", 
           "CSU Bakersfield (n = 105)", "Sacramento State (n = 240)",
           "CSU Dominguez Hills (n = 56)", 
           "San Francisco State (n = 250)", 
           "Cal State LA (n = 320)", "UC Berkeley (n = 167)", NA)

...
**Additional Notes: ** A total of `r get_count_and_percent(bns$q11, "I don't have dependents")` students reporting no dependents and `r get_count_and_percent(bns$q11, "0")` reporting dependents with less than 50% financial support were omitted from the chart. These rates differed between campus types, where `r get_count_and_percent(bns_CSU$q11, "I don't have dependents")` CSU students reported they don't have dependents, compared to `r get_count_and_percent(bns_CCC$q11, "I don't have dependents")` CCC students, and `r get_count_and_percent(bns_UC$q11, "I don't have dependents")` UC students.

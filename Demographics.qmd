...
**Additional Notes: ** A total of `r get_count_and_percent(bns$q11, "I don't have dependents")` students reporting no dependents and `r get_count_and_percent(bns$q11, "0")` reporting dependents with less than 50% financial support were omitted from the chart. These rates differed between campus types. Among CSU students, `r get_count_and_percent(bns_CSU$q11, "I don't have dependents")` reported they don't have dependents, compared to `r get_count_and_percent(bns_CCC$q11, "I don't have dependents")` among CCC students, and `r get_count_and_percent(bns_UC$q11, "I don't have dependents")` among UC students. Meanwhile, among CSU students, `r get_count_and_percent(bns_CSU$q11, "0")` reported dependents with less than 50% financial support, compared to `r get_count_and_percent(bns_CCC$q11, "0")` among CCC students, and `r get_count_and_percent(bns_UC$q11, "0")` among UC students. 

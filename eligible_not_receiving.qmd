...
The distribution of student participation for these 836 likely eligible but not receiving is the same as the overall distribution of all participating students from each of the 12 campuses (with Clovis and Butte swapped in position). See [College Campus](Academic_Profile.qmd#college-campus) for the distribution of all participating students.
...
**Additional Notes: ** @tbl-other includes responses from students who selected "Other" as a reason for not having or never using CalFresh.

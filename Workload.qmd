...
**Below is a breakdown of the academic workload, using the 3 hours of work per unit measurement. `r print_n_reporting_tmp2("q18")`**
```{r}
...
**Below is a combination of all worked hours per week, both academic and non-academic. This includes units (3 hr/unit), paid worked hours, unpaid worked hours, and caregiving hours. `r print_n_reporting_tmp("TotalHours")`**

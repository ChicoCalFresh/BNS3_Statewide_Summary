...
plot_frq(bns$q77, geom.colors = chc_blue) + xlab('Daily Fruit & Vegetable Servings') + ylab("Count")
...
plot_frq(bns$q78, geom.colors = chc_blue) + xlab('Daily Sugar Sweetened Beverage Intake (Ounces)') + ylab("Count") 
...
plot_frq(bns$q79, geom.colors = chc_blue) + xlab('Weekly Fast Food Intake') + ylab("Count")
```
:::
...
plot_frq(bns$q80, geom.colors = chc_blue) + xlab('Weekly Alcohol Intake') + ylab("Count")
...
plot_frq(bns$q81, geom.colors = chc_blue) + xlab('Alcohol Servings Consumed When Drinking') + ylab("Count")
